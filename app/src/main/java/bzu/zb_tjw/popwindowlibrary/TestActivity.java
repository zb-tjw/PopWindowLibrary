package bzu.zb_tjw.popwindowlibrary;
...
public class TestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mArrowIv = (ImageView) findViewById(R.id.image_arrow);
    }
    ...
    public void click1(View view) {
        PopWindow popWindow = new PopWindow.Builder(this)
                ...
                .addItemAction(new PopItemAction("选项3", PopItemAction.PopItemStyle.Normal, new PopItemAction.OnClickListener() {
                    @Override
                    public void onClick() {
                        Toast.makeText(TestActivity.this, "选项3", Toast.LENGTH_SHORT).show();
                    }
                }))
    ...
    public void click3(View view) {
        View customView = View.inflate(this, R.layout.layout_test, null);
        PopWindow popWindow = new PopWindow(TestActivity.this, "标题", null, PopWindow.PopWindowStyle.PopUp);
...
//                .setIsShowLine(false)
                ...
                .addItemAction(new PopItemAction("选项2"))
                .addItemAction(new PopItemAction("取消", PopItemAction.PopItemStyle.Cancel))
                .setPopWindowMargins(dip2px(30), dip2px(150), dip2px(30), dip2px(100))
                .show();
    }
